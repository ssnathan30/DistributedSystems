...
class AuthenticationApi(object):
    ...
    def logout_post(self, seller_id, **kwargs):  # noqa: E501
        """Logout  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.logout_post(seller_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.logout_post_with_http_info(seller_id, **kwargs)  # noqa: E501
        else:
            (data) = self.logout_post_with_http_info(seller_id, **kwargs)  # noqa: E501
            return data

    def logout_post_with_http_info(self, seller_id, **kwargs):  # noqa: E501
        """Logout  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.logout_post_with_http_info(seller_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('seller_id' not in params or
            ...
            raise ValueError("Missing the required parameter `seller_id` when calling `logout_post`")  # noqa: E501
