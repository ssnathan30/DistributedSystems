...
class SellersApi(object):
    ...
    def seller_rating_get(self, seller_id, **kwargs):  # noqa: E501
        """Get seller rating  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.seller_rating_get(seller_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.seller_rating_get_with_http_info(seller_id, **kwargs)  # noqa: E501
        else:
            (data) = self.seller_rating_get_with_http_info(seller_id, **kwargs)  # noqa: E501
            return data

    def seller_rating_get_with_http_info(self, seller_id, **kwargs):  # noqa: E501
        """Get seller rating  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.seller_rating_get_with_http_info(seller_id, async_req=True)
        >>> result = thread.get()
